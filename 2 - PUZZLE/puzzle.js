...
document.getElementById('puzzle').onclick = function(e) {
  //this.offsetLeft colocado en la drch
  //this.offsetTop colocado hacia abajo
...
function setBoard() {
  ...
  for (var i = 0; i < tileCount; ++i) {
    ...
    for (var j = 0; j < tileCount; ++j) {
      ...
      boardParts[i][j].x = (tileCount - 1) - i; // = i imagen sin desordenar.
      boardParts[i][j].y = (tileCount - 1) - j; // = j imagen sin desordenar.
    }
  }
